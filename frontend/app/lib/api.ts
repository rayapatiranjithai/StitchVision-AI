...
const DEMO_FALLBACK: Record<string, Record<string, unknown>> = {
  male_175: {
    ...
    skeleton_image_base64: null, style: null, warnings: ["Demo mode \u2014 sample data for 175cm male"],
  },
  female_165: {
    ...
    skeleton_image_base64: null, style: null, warnings: ["Demo mode \u2014 sample data for 165cm female"],
  },
};
